<template>
    ...
    <a v-for="(pagina, key) in sections" :key="key" :href="generateRoute(pagina)">
      <div class="w-1 rounded-xl h-8 bg-transparent transition-colors duration-200 relative overflow-hidden">
        <div class="absolute top-0 left-0 w-full h-[102%] translate-y-full bg-red-600 transition-all duration-300"></div>
      </div>
      <div class="w-full pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:text-white text-sm">
